    ...
    <BackgroundLayout>
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-2xl border border-blue-100 relative z-10 transform transition-all duration-300 hover:shadow-3xl">
        ...
        <form className="flex flex-col space-y-3.5" onSubmit={handleSubmit}>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-3 flex items-start transition-all duration-200 hover:shadow-md hover:border-blue-300">
            <input 
              type="checkbox" 
              name="agreeToTerms"
              ...
              onChange={handleChange}
              required
              className="mt-0.5 mr-2.5 rounded w-4 h-4 text-blue-600 border-gray-300 focus:ring-2 focus:ring-blue-500 cursor-pointer" 
            />
            <label className="text-xs text-gray-700">
              I agree to the{" "}
              <a href="#" className="text-blue-600 hover:text-blue-700 font-bold underline decoration-2 underline-offset-2 transition-colors duration-200">
                Terms
              </a>{" "}
              and{" "}
              <a href="#" className="text-blue-600 hover:text-blue-700 font-bold underline decoration-2 underline-offset-2 transition-colors duration-200">
